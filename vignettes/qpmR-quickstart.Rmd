...
fit <- qpm_filter(mcz, cz[, c("period", "pi4", "i", "q", "dy_obs",
                              "istar", "pistar")])
fit
```
...
0.3 adds conditional forecasts (anticipated vs unanticipated), the
judgment ledger, and forecast rounds; 0.4 Bayesian estimation. See the
README roadmap.
